...
<body>
	<form>
		...
		<table class="subsettable" style="margin: 10px;width:300px; border: 0px none; border-collapse: collapse;" >
			...
			<tr>
				<td align="center">
					<span class='AnalysisHeader'>Baseline Variable</span>
					<br />
					<br />
				...
				<td align="center">
					<span class='AnalysisHeader'>Other Variables</span>
					<br />
					<br />
					Select a folder from the Data Set Explorer tree and drag it into the box.				
				</td>					
			...
			<tr>
				<td align="right">
					<input style="font: 9pt tahoma;" type="button" onclick="clearGroupBaseline('divBaselineVariable')" value="X"> 
					<br />
					<div id='divBaselineVariable' class="queryGroupIncludeSmall"></div>
				</td>
				<td align="right">
					<input style="font: 9pt tahoma;" type="button" onclick="clearGroupScatter('divOtherVariable')" value="X"> 
					<br />
					<div id='divOtherVariable' class="queryGroupIncludeSmall"></div>
				</td>
			</tr>
			<tr><td><br/></td></tr>
			<tr>
				<td>
					<div id="displaydivBaselineVariable"></div>
				</td>
				<td>&nbsp;</td>
				<td>
					<div id = "displaydivOtherVariable"></div>
				</td>
			</tr>
			<tr><td><br/></td></tr>
			<tr>
				<td colspan="4" align="center">
					<input type="button" value="Run" onClick="submitBaselineComparison(this.form);"></input>
				</td>
			</tr>
		</table>
	</form>
