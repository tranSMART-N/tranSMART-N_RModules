...
<body>
	<form>
		...
		<table class="subsettable" style="margin: 10px;width:300px; border: 0px none; border-collapse: collapse;" >
			...
			<tr>
				<td align="center">
					<span class='AnalysisHeader'>Analysis 1</span>
					<br />
					<br />
					Select a folder from the Data Set Explorer tree and drag it into the box.
				</td>
				...
				<td align="center">
					<span class='AnalysisHeader'>Analysis 2</span>
					<br />
					<br />
					Select a folder from the Data Set Explorer tree and drag it into the box.				
				</td>					
			...
			<tr>
				<td align="right">
					<input style="font: 9pt tahoma;" type="button" onclick="clearGroupBaseline('divAnalysis1Variable')" value="X"> 
					<br />
					<div id='divAnalysis1Variable' class="queryGroupIncludeSmall"></div>
				</td>
				<td align="right">
					<input style="font: 9pt tahoma;" type="button" onclick="clearGroupScatter('divAnalysis2Variable')" value="X"> 
					<br />
					<div id='divAnalysis2Variable' class="queryGroupIncludeSmall"></div>
				</td>
			</tr>
			<tr><td><br/></td></tr>
			<tr>
				<td>
					<div id="displaydivAnalysis1Variable"></div>
				</td>
				<td>&nbsp;</td>
				<td>
					<div id = "displaydivAnalysis2Variable"></div>
				</td>
			</tr>
			<tr><td><br/></td></tr>
			<tr>
				<td colspan="4" align="center">
					<input type="button" value="Run" onClick="submitAnalysisComparison(this.form);"></input>
				</td>
			</tr>
		</table>
	</form>
