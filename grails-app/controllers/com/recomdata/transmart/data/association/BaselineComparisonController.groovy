...
class BaselineComparisonController {

	def RModulesOutputRenderService
	
	def baselineComparisonOut = 
	{
		...
		RModulesOutputRenderService.initializeAttributes(jobName,"BaselineComparison",imageLinks)
		...
		String baselineComparisonGrid = ""
		String rVersionInfo = ""
		
		baselineComparisonGrid = RModulesOutputRenderService.fileParseLoop(tempDirectoryFile,/.*baselineComparison.*\.txt/,/.*baselineComparison(.*)\.txt/,parseBaselineComparisonStr)
		rVersionInfo = RModulesOutputRenderService.parseVersionFile()
		
		render(template: "/plugin/baselineComparison_out", model:[baselineComparisonGrid:baselineComparisonGrid,zipLink:RModulesOutputRenderService.zipLink,rVersionInfo:rVersionInfo], , contextPath:pluginContextPath)

	}
	
	def parseBaselineComparisonStr =
	{
		legendInStr ->
		...
		buf.append("<table class='AnalysisResults' id='timepointComparisonTable'>")
